...
Summon a personal Recycler wherever you need it.
...
Access a portable locker anywhere for quick gear changes.
...
Reduces the cooldown of teleports from **20 seconds** to **5 seconds**.
...
Unlocks the Auto Sell system, allowing resoruces stored in your Item Bank to be sold automatically.

See the **Auto Sell** page for a complete setup guide.
...
Greatly improves visibility during the night.
...
Perfect for Deep Sea exploration and ocean monuments.
...
Unlocks a companion bear that can:
...
Continue with the **Terminal** and **Auto Sell** guides to learn how to make the most of these two perks.
